...
var reorderObjects = []; // let el = $("#sortable1");
...
var sortable = new sortablejs_modular_sortable_complete_esm_js__WEBPACK_IMPORTED_MODULE_0__["default"](el, {
  ...
  /**Event*/
  evt) {
    var toElements = evt.to.children;
    var index = 1;
    Array.from(toElements).forEach(function (item) {
      var variableId = parseInt($(item).attr('variableId'));
      reorderObjects.push({
    ...
    axios.post('/api/ussdtemplate/reorder', reorderObjects).then(function (response) {// console.log(response.data)
...
/***/ 1:
/*!****************************************!*\
  !*** multi ./resources/js/donation.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\sammy\Desktop\MY CODE PROJECTS\vote-app\resources\js\donation.js */"./resources/js/donation.js");
