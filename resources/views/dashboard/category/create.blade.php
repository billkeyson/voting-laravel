            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="{{ route('event.index') }}"><i
                                class="zmdi zmdi-home"></i>{{ $event->name }}</a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0);">{{ $category->name }}</a></li>
                    <li class="breadcrumb-item active">Nominee</li>
                            ...
                            <tbody>
                                @forelse ($nominees as $nominee)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="list-name"><a href="{{route('category.create',['catId'=>$nominee->id])}}">{{$nominee->name }}</a></span>
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <form method="POST" action="{{ route('nominee.store',['eventId'=> $event->id,'catId'=>$category->id])}}" class="needs-validation"
