...
var sortable = new sortablejs_modular_sortable_complete_esm_js__WEBPACK_IMPORTED_MODULE_1__["default"](el, {
  group: "name",
...
var variableNames = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(parameter) {
    var result;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return axios.get("/api/variable/names/".concat(parameter));
  ...
  return function variableNames(_x) {
...
var index = 0;
$("#addSingleOption").on('click', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(event) {
    var urlParam, parameter, options;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            urlParam = window.location.pathname.split('/');
            parameter = urlParam[urlParam.length - 1];
            _context2.next = 4;
            return variableNames(parameter);

          case 4:
            options = _context2.sent;
            event.preventDefault();
            $('.addOption').append("\n\t<div class=\"col-md-12 mb-2\">\n\t<div class=\"row \">\n\t\t<div class=\"col-md-3\">\n\t\t\t<input type=\"hidden\" value=\"".concat(index + 1, "\" name=\"options[items][").concat(index, "][id]\" />\n\t\t\t<div class=\"form-line\">\n\t\t\t\t<input type=\"text\" value=\"\" name=\"options[items][").concat(index, "][label]\" id=\"\" class=\"form-control\"\n\t\t\t\t\tplaceholder=\"Option Label\" />\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div class=\"col-md-3\">\n\t\t\t<div class=\"form-line\">\n\t\t\t\t<input type=\"text\" value=\"\" name=\"options[items][").concat(index, "][value]\" class=\"form-control\" id=\"\"\n\t\t\t\t\tplaceholder=\"Option Value\" />\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div class=\"col-md-3\">\n\t\t\t<div class=\"form-line\">\n\t\t\t\t<select name=\"options[items][").concat(index, "][skip]\" class=\"form-control show-tick add-options").concat(index, "\">\n\t\t\t\t\t<option value=\"\">Skip</option>\n\t\t\t\t</select>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div class=\"col-md-2\">\n\t\t\t<div class=\"form-line\">\n\t\t\t\t<select name=\"options[type]\" class=\"form-control show-tick\">\n\t\t\t\t\t<option value=\"\">type</option>\n\t\t\t\t\t<option value=\"plain\">Plain</option>\n\t\t\t\t\t<option value=\"int\">Integer</option>\n\t\t\t\t\t<option value=\"decimals\">Decimals</option>\n\t\t\t\t</select>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div class=\"col-md-1 d-flex justify-content-center align-items-center removeOption\"\n\t\t\tstyle=\"cursor: pointer\">\n\t\t\t<div class=\"form-line\">\n\t\t\t\t<div class=\"demo-google-material-icon\"> \n\t\t\t\t<i class=\"material-icons\">remove_circle</i> <span class=\"icon-name\"></span>\n\t\t\t\t</div>\n\n\t\t\t</div>\n\t\t</div>\n\t</div>\n\n</div>")); // add options to selection for skip

            options.forEach(function (item) {
              $(".add-options".concat(index)).append("<option value=\"".concat(item.name, "\">").concat(item.name, "</option>"));
            });
            index++; // console.log(options)
